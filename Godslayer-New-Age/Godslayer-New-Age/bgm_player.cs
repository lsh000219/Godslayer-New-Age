...
namespace Godslayer_New_Age
{
	internal class bgm_player
	{
		...
		public void Battle_Musk()
		{
            ...
            string bgmPath1 = Path.GetFullPath(Path.Combine(baseDir, "..", "..", "bgm", "Battle_Musk1.wav"));
            string bgmPath2 = Path.GetFullPath(Path.Combine(baseDir, "..", "..", "bgm", "Battle_Musk2.wav"));
            ...
            Console.WriteLine("Battle_Musk.wav 루프 재생 중입니다. 종료하려면 Enter 키를 누르세요.");
            Console.ReadLine();
